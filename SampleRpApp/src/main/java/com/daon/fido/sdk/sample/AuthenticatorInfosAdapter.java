...
public class AuthenticatorInfosAdapter extends ArrayAdapter<AuthenticatorInfo> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView lastUsed = convertView.findViewById(R.id.auth_last_used);
        TextView created = convertView.findViewById(R.id.auth_created);
        TextView status = convertView.findViewById(R.id.auth_status);
