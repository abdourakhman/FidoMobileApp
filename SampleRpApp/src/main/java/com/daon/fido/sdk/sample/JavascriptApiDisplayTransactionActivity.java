...
public class JavascriptApiDisplayTransactionActivity extends LoggedInActivity {

    private static final String TAG = JavascriptApiDisplayTransactionActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "JavascriptApiDisplayTransactionActivity onCreate");
    ...
    private void cancelPressed() {
        ((CoreApplication) getApplication()).getFido().submitDisplayTransactionResult(RESULT_CANCELED, null);
        finish();
    }

    private void okPressed() {
        ((CoreApplication) getApplication()).getFido().submitDisplayTransactionResult(RESULT_OK, null);
        finish();
    }
}
