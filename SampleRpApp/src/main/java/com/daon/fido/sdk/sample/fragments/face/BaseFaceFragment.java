package com.daon.fido.sdk.sample.fragments.face;
...
import com.daon.fido.sdk.sample.fragments.face.camera.CameraXWrapper;
...
public abstract class BaseFaceFragment extends BaseCaptureFragment implements FaceControllerProtocol.FaceAnalysisListener {
    ...
    private static final String TAG = BaseFaceFragment.class.getSimpleName();
    ...
    public void onFailure(AuthenticatorError error, LockResult result) {
        Log.d(TAG, "BaseFace onFailure :" + error.getCode());
        stopCameraPreview();
        stopCapture();
