...
public final class FaceViewModel_Factory implements Factory<FaceViewModel> {
  ...
  public FaceViewModel_Factory(Provider<Application> applicationProvider,
  ...
  public static FaceViewModel_Factory create(Provider<Application> applicationProvider,
      Provider<IXUAF> fidoProvider, Provider<SharedPreferences> prefsProvider) {
    return new FaceViewModel_Factory(applicationProvider, fidoProvider, prefsProvider);
  }

  public static FaceViewModel newInstance(Application application, IXUAF fido,
      SharedPreferences prefs) {
    return new FaceViewModel(application, fido, prefs);
  }
}
